    ...
    def stream_inference(self, source=None, model=None):
        ...
        for batch in self.dataset:
            ...
            with self.dt[1]:
                ...
                preds = self.model(im, augment=self.args.augment, visualize=visualize)  #[1, 84, 6300], [3, 1, 144 80 60]
                # print("*****************Output of model yolo*****************")
                # print(len(preds), preds[0].size(), len(preds[1]), len(preds[1][0]), len(preds[1][0][0]), len(preds[1][0][0][0]), len(preds[1][0][0][0][0]))
