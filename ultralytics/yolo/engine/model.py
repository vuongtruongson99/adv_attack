...
class YOLO:
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8x.pt', task=None) -> None:
        """
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        if not self.predictor:
            print("############### self.predictor chua duoc khoi tao ###############")
    ...
    def tune(self,
        ...
        tuner = tune.Tuner(trainable_with_resources,
                           ...
                           run_config=RunConfig(callbacks=tuner_callbacks, local_dir='./haha'))
