...
class Loss:
    ...
    def __call__(self, preds, batch):
        ...
        print("mask_gt:", mask_gt, mask_gt.size())
        ...
        # print("Target score: ", max(target_scores.sum(), 1), target_scores.size())
        target_bboxes /= stride_tensor
        target_scores_sum = max(target_scores.sum(), 1)

        # print("pred_scores:", pred_scores, pred_scores.size())
        # print("Target_Scores:", target_scores.sum())
        ...
        print(f"Loss box | loss cls | loss dfl: {loss[0]} | {loss[1]} | {loss[2]}")
